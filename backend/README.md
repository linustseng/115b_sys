...
- Students: id, name, email, studentNo, phone, company, title, dietaryPreference, notes
- Checkins: id, eventId, registrationId, checkinAt, checkinMethod
- ShortLinks: id, eventId, type, slug, targetUrl, createdAt
- Directory: email, nameZh, nameEn, preferredName, socialUrl, mobile, backupPhone, emergencyContact, emergencyRelation, emergencyPhone
