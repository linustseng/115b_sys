...
## 11. 班費管理功能設計草案 (v1)
### 11.1 角色與權限 (依辦法)
- 同學/申請人: 建立請購、請款、零用金申請; 查看自己案件狀態; 補件/撤回
- 組長: 金額 <= 50,000 的核決; 所有案件第一關審核
- 班代: 金額 > 50,000 且 < 200,000 的第二關覆核
- 班級幹部 (班代/副班代/各部長): 金額 >= 200,000 或「特殊性班務」的集體核決
- 財務 (會計組): 作帳、入帳、結案
- 出納: 付款/轉帳、零用金發放與撥補紀錄
- 班費監察人: 可檢視全帳與報表 (唯讀)

### 11.2 核心流程設計 (依金額與性質決定路徑)
註: 請購不需先於請款。

#### A. 請購 (事前)
- 申請人送出 -> 組長審核
- 金額 <= 50,000: 組長同意即可結案 (等待後續請款)
- 50,000 < 金額 < 200,000: 組長同意 -> 班代覆核
- 金額 >= 200,000 或特殊性班務: 組長支持 -> 幹部會議 2/3 同意 -> 進入請款

#### B. 請款 (事後/實報)
- 申請人送出 (需連結對應請購或填「未經請購」原因)
- 金額 <= 50,000: 組長核決 ->
  - 若零用金: 出納發放 -> 會計作帳 -> 結案
  - 若轉帳: 會計作帳 -> 出納轉帳 -> 結案
- 50,000 < 金額 < 200,000: 組長核決 -> 班代覆核 -> 會計作帳 -> 出納轉帳 -> 結案
- 金額 >= 200,000 或特殊性: 組長核決 -> 班代覆核 -> 幹部會議 2/3 同意 -> 會計作帳 -> 出納轉帳 -> 結案

#### C. 零用金
- 申請人 -> 組長核決 -> 出納發放 -> 零用金登載/撥補 -> 會計作帳 -> 結案
- 金額上限: 50,000 (依辦法)
